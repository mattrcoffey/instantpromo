...
?>
<?php
class MagenThemes_MTBelano_Adminhtml_RestoreController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _isAllowed()
    {
        return Mage::getSingleton('admin/session')
            ->isAllowed('magenthemes/mtbelano/restore');
    }

    protected function _initAction()
    {
        $this->loadLayout()
            ->_setActiveMenu('magenthemes/mtbelano/restore')
    ...
    public function indexAction()
    {
        ...
        $this->_title($this->__('MagenThemes'))
            ->_title($this->__('mtbelano'))
            ->_title($this->__('Restore Defaults'));
        $this->_addContent($this->getLayout()->createBlock('mtbelano/adminhtml_restore_edit'));
        $this->renderLayout();
    }
    ...
    public function restoreAction()
    {
	    ...
	    try {
            ...
            $defaults->loadFile(Mage::getBaseDir().'/app/code/local/MagenThemes/MTBelano/etc/config.xml');
            $this->_restoreSettings($defaults->getNode('default/mtbelano_design')->children(), 'mtbelano_design');
            Mage::getSingleton('adminhtml/session')->addSuccess(
                Mage::helper('adminhtml')->__('Default Settings for mtbelano Design Theme has been restored.'));
        }
        catch (Exception $e) {
